    ...
    return (
      ...
      <View style={{flex: 1, marginLeft:"auto", marginRight:"auto", padding:"5%"}}>
        ...
        <View style={{flex: 1, alignItems:"baseline"}}>
          ...
          <Text style={{ color:"grey", marginTop:"3%", marginLeft:"1%", marginRight:"1%", fontSize:13}}>* Push 알림을 수신하고자 하는 이용자는 메인화면 알림확인 →</Text>
          <Text style={{ color:"grey", marginLeft:"1%", marginRight:"1%", fontSize:13}}>알림설정 → ON 선택 바랍니다.</Text>
        </View>

        <View style={{flex: 1, width:"100%" , alignContent:"space-around"}}>
          ...
          <Text style={{marginTop:"3%", color:"grey", fontSize:13, marginLeft:"1%", marginRight:"1%"}}>* 현재 생활원에 거주중인 원생이 이용가능한 게시판입니다.</Text>
          </View>
          
          <View style={{marginTop:"3%"}}>
          <Button title={"비원생 게시판 바로가기"} onPress={() => {Linking.openURL('https://dorm.pusan.ac.kr/');}}/>
          <Text style={{marginTop:"3%", color:"grey", fontSize:13, marginLeft:"1%", marginRight:"1%"}}>* 현재 생활원에 거주중이지 않은 비원생이 이용가능한 게시판입니다.</Text>
          </View>

          <View style={{marginTop:"3%"}}>
          <Button title={"생활원 전화문의"} onPress={()=> {Linking.openURL(`tel:051-510-7827`);}} />
          <Text style={{marginTop:"3%", color:"grey", fontSize:13, marginLeft:"1%", marginRight:"1%"}}>* 행정실 운영시간: 평일9시 ~ 18시 / 12시 ~ 13시 제외</Text>
          </View>
        </View>
